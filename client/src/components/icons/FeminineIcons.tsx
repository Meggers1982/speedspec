...
export const ChicPlusIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      d="M12 5V19M5 12H19"
      stroke="currentColor"
...
export const ChicXIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
...
export const ChicSettingsIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <circle
      cx="12"
      cy="12"
...
export const ChicShoppingCartIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
...
export const ChicUsersIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
...
export const ChicClipboardIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
...
export const ChicSaveIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
...
export const ChicHelpIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <circle
      cx="12"
      cy="12"
...
export const ChicMapIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
...
export const ChicAlertIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      d="M10.29 3.86L1.82 18C1.64466 18.3024 1.55685 18.6453 1.56525 18.9928C1.57366 19.3402 1.67787 19.6782 1.86872 19.9718C2.05956 20.2654 2.32989 20.5034 2.65222 20.6602C2.97456 20.8169 3.33712 20.8874 3.70001 20.864H20.3C20.6629 20.8874 21.0254 20.8169 21.3478 20.6602C21.6701 20.5034 21.9405 20.2654 22.1313 19.9718C22.3221 19.6782 22.4263 19.3402 22.4348 18.9928C22.4432 18.6453 22.3553 18.3024 22.18 18L13.71 3.86C13.5318 3.56611 13.2807 3.32312 12.9812 3.15133C12.6817 2.97954 12.3438 2.88477 12 2.88477C11.6562 2.88477 11.3183 2.97954 11.0188 3.15133C10.7193 3.32312 10.4682 3.56611 10.29 3.86V3.86Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ChicTrendingIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
...
export const ChicDownloadIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
...
export const ChicCopyIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <rect
      x="9"
      y="9"
...
export const ChicRocketIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      d="M4.5 16.5C6 14 11.5 15.5 11.5 15.5S13 21 10.5 22.5L9 21L8 19L4.5 16.5Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    />
    <path
      d="M21.5 2.5C21.5 2.5 17.5 6.5 12 12L15.5 15.5C21 10 21.5 2.5 21.5 2.5Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M16 8L2 22L3.5 23.5L17.5 9.5"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ChicCalendarIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <rect
      x="3"
      y="4"
...
export const ChicTargetIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <circle
      cx="12"
      cy="12"
...
export const ChicCodeIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      d="M16 18L22 12L16 6"
      stroke="currentColor"
